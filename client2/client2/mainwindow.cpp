    ...
    , ui(new Ui::MainWindow)
{
    ...
    this->udpSocket->bind(QHostAddress::LocalHost, 9999);
    connect(this->udpSocket, SIGNAL(readyRead()), this, SLOT(ReadingData()));

    this->setWindowTitle("client 2");
}
...
{
    this->udpSocket->writeDatagram(ui->lineEdit->text().toUtf8(), QHostAddress::LocalHost, 1111);
